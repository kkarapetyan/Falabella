...
extension AttributesViewController: AttributesPresenterDelegate {
    ...
    ///Show  Login view
    func showLogin() {
        let vc = LoginViewController(nibName: Constant.NibNames.login, bundle: getBundleURL(myClass: LoginViewController.self))
    ...
    func presentDetails(valuta: Valuta) {
        let detailsVC = DetailsViewController(nibName: Constant.NibNames.details, bundle: getBundleURL(myClass: DetailsViewController.self))
